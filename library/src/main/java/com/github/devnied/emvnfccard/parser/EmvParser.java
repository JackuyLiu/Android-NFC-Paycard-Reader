    ...
    protected boolean readWithPSE() throws CommunicationException {
        ...
        if (ResponseUtils.isSucceed(data)) {
            ...
            if (ResponseUtils.isSucceed(data)) {
                ...
                for (byte[] aid : aids) {
                    ret = extractPublicData(aid, extractApplicationLabel(data));//PBOC DEBIT
                    if (ret == true) {
                        break;
                    }
                }
...
//      list = {ArrayList@20002}  size = 9
//		0 = {TagAndLength@20004} "Tag[9F 66] Name=Terminal Transaction Qualifiers, TagType=PRIMITIVE, ValueType=BINARY, Class=CONTEXT_SPECIFIC length: 4"
//		1 = {TagAndLength@20005} "Tag[9F 02] Name=Amount, Authorised (Numeric), TagType=PRIMITIVE, ValueType=NUMERIC, Class=CONTEXT_SPECIFIC length: 6"
//		2 = {TagAndLength@20006} "Tag[9F 03] Name=Amount, Other (Numeric), TagType=PRIMITIVE, ValueType=NUMERIC, Class=CONTEXT_SPECIFIC length: 6"
//		3 = {TagAndLength@20007} "Tag[9F 1A] Name=Terminal Country Code, TagType=PRIMITIVE, ValueType=TEXT, Class=CONTEXT_SPECIFIC length: 2"
//		4 = {TagAndLength@20008} "Tag[95] Name=Terminal Verification Results (TVR), TagType=PRIMITIVE, ValueType=BINARY, Class=CONTEXT_SPECIFIC length: 5"
//		5 = {TagAndLength@20009} "Tag[5F 2A] Name=Transaction Currency Code, TagType=PRIMITIVE, ValueType=TEXT, Class=APPLICATION length: 2"
//		6 = {TagAndLength@20010} "Tag[9A] Name=Transaction Date, TagType=PRIMITIVE, ValueType=NUMERIC, Class=CONTEXT_SPECIFIC length: 3"
//		7 = {TagAndLength@20011} "Tag[9C] Name=Transaction Type, TagType=PRIMITIVE, ValueType=NUMERIC, Class=CONTEXT_SPECIFIC length: 1"
//		8 = {TagAndLength@20012} "Tag[9F 37] Name=Unpredictable Number, TagType=PRIMITIVE, ValueType=BINARY, Class=CONTEXT_SPECIFIC length: 4"
